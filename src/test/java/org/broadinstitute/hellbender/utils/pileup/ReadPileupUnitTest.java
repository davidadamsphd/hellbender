...
public final class ReadPileupUnitTest {
    ...
    public void testSplitByReadGroup() {
        ...
        final ReadPileup rg1Pileup = pileup.getPileupForReadGroup("rg1");
        ...
        final ReadPileup rg2Pileup = pileup.getPileupForReadGroup("rg2");
    ...
    public void testSplitByNullReadGroups() {
        ...
        final ReadPileup nullRgPileup = pileup.getPileupForReadGroup(null);
    ...
    private class RBPCountTest {
        ...
        private RBPCountTest(final int nReads, final int nMapq0, final int nDeletions) {
    ...
    public void testRBPCountingTestSinglePileup(final RBPCountTest params) {
        testRBPCounts(params.makePileup(), params);
    }

    private void testRBPCounts(final ReadPileup rbp, final RBPCountTest expected) {
