...
public class PedReader {
    private static Logger logger = LogManager.getLogger(PedReader.class);
    ...
    public final List<Sample> parse(Reader reader, EnumSet<MissingPedField> missingFields, SampleDB sampleDB) {
        // @TODO: CMN what is the correct comment prefix (last arg) fo XReadLines ???
        // @TODO: GATK hardocdes "#"???
        try (final XReadLines sourceReader = new XReadLines(reader, false, "#")) {

            final List<String> lines = sourceReader.readLines();
            ...
            final int nExpectedFields = Utils.arrayMaxInt(Arrays.asList(samplePos, paternalPos, maternalPos, sexPos, phenotypePos)) + 1;
            ...
            for (final String line : lines) {
                ...
                if (parts.length != nExpectedFields)
                    ...
                    // TODO CMN - get File for MalformedFileException
                ...
                if (phenotypePos != -1) {
                    if (isQT) {
                        ...
                        if (parts[phenotypePos].equals(MISSING_VALUE1)) affection = Affection.UNKNOWN;
                            ...
                            // @TODO: CMN find GATKReviewException
            ...
            //@TODO - CMN improve error message
